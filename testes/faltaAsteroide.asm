...
apaga_pixel:
    ...
    MOV     [DEFINE_LINHA], R2              ; seleciona a linha
    MOV     [DEFINE_COLUNA], R3             ; seleciona a coluna
    MOV     R2, 0                           ; pixel apagado
    MOV     [ALTERA_COR_SONDA_C], R2        ; apaga o pixel na linha e coluna selecionadas
...
move_sonda:
    ...
    MOV     R1, [R0]                        ; nº de movimentos realizados + 1
    SUB     R1, 1                           ; nº de movimentos realizados
    CMP     R1, R2                          ; já realizou os 12 movimentos?
...
cria_sonda:
    ...
    ADD     R0, 2                           ; endereço da variável que guarda o nº de movimentos realizados
    MOV     R3, [R0]                        ; nº de movimentos realizados + 1
    ADD     R3, 1                           ; adiciona-se 1 apesar de o primeiro não ser um movimento
    MOV     [R0], R3                        ; atualiza a variável relativa aos movimentos da sonda
    JMP     exit_sonda
...
apaga_sonda:
    ...
    MOV     R3, COLUNA_SONDA                ; coluna da sonda
    CALL    apaga_pixel                     ; apaga o pixel
...
reinicia_sonda:
    ...
    SUB     R0, 2                           ; endereço da tabela relativa à sonda
...
game_over_ciclo:
    MOV     R1, TECLA_START                 ; tecla para reiniciar o jogo
    CALL    teclado                         ; lê o teclado
    CMP     R3, R1                          ; a tecla lida é o "C"?
