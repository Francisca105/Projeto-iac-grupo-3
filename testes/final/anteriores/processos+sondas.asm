...
DEF_NAVE:
    ...
    WORD    CINZA_ESCURO, CINZA_CLARO, CINZA_CLARO, CINZA_ESCURO, AZUL, VERMELHO, VERDE, CINZA_INTERMEDIO, VERMELHO, VERDE, CINZA_INTERMEDIO, CINZA_ESCURO, CINZA_CLARO, CINZA_CLARO, CINZA_ESCURO
    WORD    CINZA_ESCURO, CINZA_CLARO, CINZA_CLARO, CINZA_ESCURO, CINZA_INTERMEDIO, CINZA_INTERMEDIO, AZUL, AZUL, VERDE, CINZA_INTERMEDIO, VERMELHO, CINZA_ESCURO, CINZA_CLARO, CINZA_CLARO, CINZA_ESCURO
