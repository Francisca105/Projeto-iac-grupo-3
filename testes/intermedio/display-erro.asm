...
TECLA_MEIO  		     EQU 14H	      ; tecla 2
TECLA_DIREITA 			 EQU 12H		  ; tecla 1
...
; JOGO
ENERGIA            EQU 064H	; número de energia inicial
...
inicio:
    ...
    CALL    display                         ; mostra o nível de energia no painel
...
aumentar_energia:
    ADD    R0, 1                           ; aumenta o nível de energia

diminuir_energia:
    SUB    R0, 1                           ; diminui o nível de energia

main:
    MOV     R0, ENERGIA                        ; número de energia inicial
    CALL    display                            ; mostra o nível de energia no painel
    MOV     R9, TECLA_PAUSAR                   ; guarda o valor da tecla na variável R9
    MOV     R10, TECLA_TERMINAR                ; guarda o valor da tecla na variável R10
    CMP     R3, R9                             ; verifica se a tecla de pausa foi pressionada
    JZ      aumentar_energia                   ; se sim, aumenta o nível de energia
    CMP     R3, R10                 ; verifica se a tecla de terminar foi pressionada
    JZ      diminuir_energia                   ; se sim, diminui o nível de energia

    CALL     main                              ; se não, volta ao ciclo do jogo
