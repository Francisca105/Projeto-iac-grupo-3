...
ciclo:
    ...
    MOV     R1, TECLA_ESQUERDA              ; tecla para incrementar em uma unidade(hexadecimal) o display
    CMP     R3, R1                          ; a tecla lida é o "0"?
    JZ      aumentar_energia                ; se sim, incrementa o display
    MOV     R1, TECLA_DIREITA               ; tecla para decrementar em uma unidade(hexadecimal) o display
    CMP     R3, R1                          ; a tecla lida é o "2"?
    JZ      diminuir_energia                ; se sim, decrementa o display
