...
inicio:
    MOV     SP, SP_inicial
    MOV     BTE, tab            			; inicializa BTE (registo de Base da Tabela de Excepções)
...
;               Esta rotina é executada quando ocorre uma interrupção                
;               do tipo 0.
;               A interrupção do tipo 0 ocorre de forma ciclica para alterar o painel.
; **********************************************************************
rot_int_0:
	CALL muda_painel
